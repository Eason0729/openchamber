...
| `opencode-go` | OpenCode | `providers/opencode-go.js` | `opencode-go`, `opencode_go`, `opencodego`; env `OPENCODE_GO_WORKSPACE_ID` / `OPENCODE_GO_AUTH_COOKIE`; browser cookie auto-discovery |
